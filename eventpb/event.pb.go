...
type EventFilterRule struct {
	...
	IgnoreUpdateOnlyColumns  []string `protobuf:"bytes,8,rep,name=ignore_update_only_columns,json=ignoreUpdateOnlyColumns,proto3" json:"ignore_update_only_columns,omitempty"`
}
...
func (m *EventFilterRule) GetIgnoreUpdateOnlyColumns() []string {
	if m != nil {
		return m.IgnoreUpdateOnlyColumns
	}
	return nil
}
...
type DispatcherRequest struct {
	...
	TxnAtomicity                  string                    `protobuf:"bytes,19,opt,name=txn_atomicity,json=txnAtomicity,proto3" json:"txn_atomicity,omitempty"`
	EnableIgnoreUpdateOnlyColumns bool                      `protobuf:"varint,20,opt,name=enable_ignore_update_only_columns,json=enableIgnoreUpdateOnlyColumns,proto3" json:"enable_ignore_update_only_columns,omitempty"`
	LowLatencyMode                bool                      `protobuf:"varint,21,opt,name=low_latency_mode,json=lowLatencyMode,proto3" json:"low_latency_mode,omitempty"`
}
...
func (m *DispatcherRequest) GetTxnAtomicity() string {
	if m != nil {
...
func (m *DispatcherRequest) GetEnableIgnoreUpdateOnlyColumns() bool {
	if m != nil {
...
func (m *DispatcherRequest) GetLowLatencyMode() bool {
	if m != nil {
...
var fileDescriptor_d7fb2554dfcf7f7d = []byte{
	...
	,
}
...
func (m *EventFilterRule) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.IgnoreUpdateOnlyColumns) > 0 {
		for iNdEx := len(m.IgnoreUpdateOnlyColumns) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.IgnoreUpdateOnlyColumns[iNdEx])
			copy(dAtA[i:], m.IgnoreUpdateOnlyColumns[iNdEx])
			i = encodeVarintEvent(dAtA, i, uint64(len(m.IgnoreUpdateOnlyColumns[iNdEx])))
			i--
			dAtA[i] = 0x42
		}
	}
...
func (m *DispatcherRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EnableIgnoreUpdateOnlyColumns {
		i--
		if m.EnableIgnoreUpdateOnlyColumns {
			dAtA[i] = 1
		} else {
	...
	if len(m.TxnAtomicity) > 0 {
		i -= len(m.TxnAtomicity)
		copy(dAtA[i:], m.TxnAtomicity)
		i = encodeVarintEvent(dAtA, i, uint64(len(m.TxnAtomicity)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
...
func (m *EventFilterRule) Size() (n int) {
	...
	if len(m.IgnoreUpdateOnlyColumns) > 0 {
		for _, s := range m.IgnoreUpdateOnlyColumns {
			l = len(s)
			n += 1 + l + sovEvent(uint64(l))
		}
	}
...
func (m *EventFilterRule) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IgnoreUpdateOnlyColumns", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IgnoreUpdateOnlyColumns = append(m.IgnoreUpdateOnlyColumns, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *DispatcherRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxnAtomicity", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxnAtomicity = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableIgnoreUpdateOnlyColumns", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableIgnoreUpdateOnlyColumns = bool(v != 0)
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LowLatencyMode", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
