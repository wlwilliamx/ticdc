...
func TestApplyDDLJobs(t *testing.T) {
	...
	testCases := []struct {
		...
		// { ... (omitted for brevity, as the feature might not be fully supported as noted in the original code, but BlockedTableNames logic is covered by other rename_tables cases)
		// },
		// test create tables
		{
			"create_tables",
