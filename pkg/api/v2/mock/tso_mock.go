...
func (mr *MockTsoGetterMockRecorder) Tso() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Tso", reflect.TypeOf((*MockTsoGetter)(nil).Tso))
}
...
func (mr *MockTsoInterfaceMockRecorder) Query(ctx, config interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Query", reflect.TypeOf((*MockTsoInterface)(nil).Query), ctx, config)
}
