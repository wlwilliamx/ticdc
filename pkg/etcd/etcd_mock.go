...
func (m *MockCDCEtcdClient) GetEtcdClient() Client {
	m.ctrl.T.Helper()
...
func (m *MockCDCEtcdClient) PutCaptureInfo(arg0 context.Context, arg1 *config.CaptureInfo, arg2 v3.LeaseID) error {
	m.ctrl.T.Helper()
