...
func TestIsEligible(t *testing.T) {
	...
	require.NoError(t, err)
	filterImpl := f.(*filter)
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiWithPK)))
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiWithUK)))
	require.False(t, filterImpl.isEligible(common.WrapTableInfo("test", tiWithNullableUK)))
	require.False(t, filterImpl.isEligible(common.WrapTableInfo("test", tiNoKey)))
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiView)))
	require.False(t, filterImpl.isEligible(common.WrapTableInfo("test", tiSeq)))
	...
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiWithPK)))
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiWithUK)))
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiWithNullableUK)))
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiNoKey)))
	require.True(t, filterImpl.isEligible(common.WrapTableInfo("test", tiView)))
	require.False(t, filterImpl.isEligible(common.WrapTableInfo("test", tiSeq)), "Sequence should always be ineligible")
}
