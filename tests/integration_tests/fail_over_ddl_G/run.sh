...
function failOverCaseG-1() {
    ...
    export GO_FAILPOINTS='github.com/pingcap/ticdc/downstreamadapter/dispatcher/BlockBeforePass=pause'
...
function failOverCaseG-5() {
	...
	echo "failOverCaseG-5 passed successfully"
}
